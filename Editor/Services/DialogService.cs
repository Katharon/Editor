...
namespace Editor.Services
{
    ...
    public class DialogService : IDialogService
    {
        ...
        {
            return this.ShowOpenFileDialog("Erweiterungsset laden", "Erweiterungssets (*.extset)|*.extset");
        }

        /// <inheritdoc/>
        public string? ShowSaveExtensionSetDialog()
        {
            return this.ShowSaveFileDialog("Erweiterungsset speichern", "Erweiterungssets (*.extset)|*.extset", ".extset");
        }
